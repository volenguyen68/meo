...
var ID = "bongo-cat";
var s = function (selector) { return "#" + ID + " " + selector; };
var notes = document.querySelectorAll(".note");
for (var _i = 0, notes_1 = notes; _i < notes_1.length; _i++) {
    var note = notes_1[_i];
    (_b = (_a = note) === null || _a === void 0 ? void 0 : _a.parentElement) === null || _b === void 0 ? void 0 : _b.appendChild(note.cloneNode(true));
    (_d = (_c = note) === null || _c === void 0 ? void 0 : _c.parentElement) === null || _d === void 0 ? void 0 : _d.appendChild(note.cloneNode(true));
}
...
var dir = function (amt) { return gsap.utils.random(["-", "+"]) + "=" + amt; };
